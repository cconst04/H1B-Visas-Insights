...
top_companies_by_soc_state <- merge(top_companies_by_soc_state,soc_codes,by = "SOC_CODE")
top_companies_by_soc_state <- rename(top_companies_by_soc_state[,2:5],SOC_CODE = job_category)


top_companies_by_soc_state <- merge(top_companies_by_soc_state,states[c("Code","State")],by.x = "EMPLOYER_STATE",by.y = "Code")
top_companies_by_soc_state <- rename(top_companies_by_soc_state[,2:5],EMPLOYER_STATE = State)
